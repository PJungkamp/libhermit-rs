...
#![feature(global_asm)]
#![no_std]
#![cfg_attr(any(target_os = "hermit", target_os = "none"), feature(custom_test_frameworks))]
#![cfg_attr(any(target_os = "hermit", target_os = "none"), cfg_attr(test, test_runner(crate::test_runner)))]
#![cfg_attr(
	any(target_os = "hermit", target_os = "none"),
	cfg_attr(test, reexport_test_harness_main = "test_main")
)]
#![cfg_attr(any(target_os = "hermit", target_os = "none"), cfg_attr(test, no_main))]
